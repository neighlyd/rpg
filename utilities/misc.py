...
def first_verb(player, entry):
    """
        Iterates through the player's input and compares it to the list of accepted verbs. Returns the first verb found.
...
def first_noun(player, entry):
    """
        Iterates through player's input and compares it with the list of generic, accepted nouns. Returns the first noun
        found.
    :param entry: User's cleaned input.
