class Inventory:
    ...
    def add_item(self, item):
        ...
        if item.name in self.items:
            ...
            # Create a key for the item name and set up a list that includes the instance of this item that was passed
            #  to the method.
    ...
    def remove_item(self, item):
        ...
        if item.name in self.items:
            ...
            # The player does not have an instance of this object in their inventory (or it somehow
